                ...
                <div className="fixed bg-black/15 z-50 inset-0">
                    <div className="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                        ...
                        <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle lg:w-4xl w-full">
                            ...
                            <div className="bg-gray-50  px-4 py-3 sm:px-6 flex justify-between lg:items-center">
                                <button
                                    type="button"
                                ...
                                <button
                                    type="button"
                                    onClick={closeModal}
                                    className="w-fit inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-red-600 mx-3 hover:bg-red-700 text-white text-base font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm"
                                >
                                    Close
                                </button>
                            </div>
