            ...
            <>
                ...
                <div className="mt-4 border-t pt-4">
                    ...
                    <div className="flex overflow-x-auto gap-2 pb-2">
                        {/* Only show first photo if all are the same */}
                        {(unit.photos.every(photo => photo.id === unit.photos[0].id))
                            ? (
                                <button
                                    onClick={() => openModal(0)}
                ...
                {isModalOpen && (
                    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/75">
                        <div className="relative max-w-4xl w-full max-h-[90vh]">
                            ...
                            {/* Only show navigation if photos are different AND more than one photo exists */}
                            {!unit.photos.every(photo => photo.id === unit.photos[0].id) && unit.photos.length > 1 && (
                                <>
                                    <button
