            ...
            <div className="space-y-4">
                ...
                {editing && (
                    <button
                        ...
                        className="hidden items-center justify-center w-full py-2 border-2 border-dashed border-blue-200 rounded-lg text-blue-600 hover:bg-blue-50 transition-colors"
                    >
